...
```
chucknorris <command> [arguments] [flags]
```

Run `chucknorris <command> --help` for the full flag list on any command. This
...
per operation you declare in `chucknorris/domain.go`.
