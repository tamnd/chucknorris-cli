// Package cli assembles the chucknorris command tree from the chucknorris
...
// NewApp assembles the kit application from the chucknorris domain. The
...
//
// To add a command, declare it in chucknorris/domain.go with kit.Handle and it
// appears here automatically. Reach for app.AddCommand only for a verb that does
// not fit the emit-records shape, the way version does below.
func NewApp() *kit.App {
	id := chucknorris.Domain{}.Info().Identity
	id.Version = Version

	app := kit.New(id)
	(chucknorris.Domain{}).Register(app)
